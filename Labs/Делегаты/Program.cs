...
namespace delegat
{
    ...
    internal delegate void VectorDelegate(Point a, Point b);

    internal delegate void WashDelegate(Garage.Car car);

    internal delegate void DelAttantion(Garage.Car car);

    internal delegate void EventTest(object point);
